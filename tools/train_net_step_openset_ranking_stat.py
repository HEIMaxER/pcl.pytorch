...
def parse_args():
    ...
    parser.add_argument(
        '--r_stat_dim', dest='r_stat_dim',
        help='Number of dimensions to take into acount in ranking statistics for self supervision', default=5, type=int)
...
def save_ckpt(output_dir, args, step, train_size, model, optimizer, unkwn_nbr, seed, rank, loss):
    """Save checkpoint"""
    if args.no_save:
        return
    ...
    save_name = os.path.join(ckpt_dir, 'model_{}_{}_{}_{}_step{}.pth'.format(unkwn_nbr, seed, rank, loss, step))
